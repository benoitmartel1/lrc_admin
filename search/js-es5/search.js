...
function fillGrid(data) {
  ...
  categories = activities.map(function (n) {
    ...
    cat.id = n.CategoryId; //console.log(cat);

    return cat;
  });
  console.log(categories); //Alpha sort
  ...
  locations.sort(function (a, b) {
    ...
    var textA = a.FullName.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
    var textB = b.FullName.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
